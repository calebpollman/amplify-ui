...
describe('useMessage', () => {
    ...
    (layout, layoutComponent, layoutProps) => {
      ...
      expect(props).toEqual(
        expect.objectContaining({
          ...
          onClose: expect.any(
            Function
          ) as InAppMessageComponentBaseProps['onClose'],
          onDisplay: expect.any(
            Function
          ) as InAppMessageComponentBaseProps['onDisplay'],
          style: undefined,
        })
      );
    }
  ...
  describe('event handling', () => {
    ...
    beforeEach(() => {
      ...
      (
        Notifications.InAppMessaging.notifyMessageInteraction as jest.Mock
      ).mockClear();
    });
    ...
    describe('onClose', () => {
      it('calls the expected methods', () => {
        ...
        expect(
          Notifications.InAppMessaging.notifyMessageInteraction
